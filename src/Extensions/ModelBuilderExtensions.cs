...
internal static class ModelBuilderExtensions
{
    internal static ModelBuilder MapAuditR(this ModelBuilder modelBuilder, AuditRConfiguration auditRConfiguration)
    {
        ...
        {
            b.Property(c => c.OldValue);
            b.Property(c => c.NewValue);
            b.Property(c => c.PropertyName).IsRequired();
        });

        modelBuilder.Entity<AuditEntryProperty>()
            .ToTable(auditRConfiguration.AuditEntryPropertyTableName, auditRConfiguration.Schema);
        modelBuilder.Entity<AuditEntry>().HasMany(m => m.AuditEntryProperties)
            .WithOne(m => m.AuditEntry);
